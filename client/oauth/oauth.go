...
// OAuth 权限
type OAuth struct {
	config client.Configer
}

// NewOAuth ...
func NewOAuth(conf client.Configer) *OAuth {
	return &OAuth{
		config: conf,
	}
}
...
func (o *OAuth) GetAccessToken(code string) (*AccessTokenReply, error) {
	result, err := client.Get("https://api.weixin.qq.com/sns/oauth2/access_token", map[string]string{
...
func (o *OAuth) RefreshToken(accessToken string) (*RefreshTokenReply, error) {
	result, err := client.Get("https://api.weixin.qq.com/sns/oauth2/refresh_token", map[string]string{
		"appid":         o.config.AppID(),
...
func (o *OAuth) GetUserInfo(accessToken, openID string) (*UserInfoReply, error) {
	result, err := client.Get("https://api.weixin.qq.com/sns/userinfo", map[string]string{
...
func (o *OAuth) CheckAccessToken(accessToken, openID string) (bool, error) {
	_, err := client.Get("https://api.weixin.qq.com/sns/auth", map[string]string{
		"access_token": accessToken,
		"openid":       openID,
	})
	if err != nil {
...
func (o *OAuth) Code2Session(code string) (*Code2SessionReponse, error) {
	result, err := client.Get("https://api.weixin.qq.com/sns/jscode2session", map[string]string{
		"appid":      o.config.AppID(),
		"secret":     o.config.AppSecret(),
		"js_code":    code,
		"grant_type": "authorization_code",
